...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView theUserId;
  ...
  private FragmentProfileBinding(@NonNull ConstraintLayout rootView, @NonNull Button logoutButton,
      @NonNull ImageView profileImageView, @NonNull TextView theUserId,
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.theUserId;
      TextView theUserId = ViewBindings.findChildViewById(rootView, id);
      if (theUserId == null) {
        break missingId;
      }
      ...
      return new FragmentProfileBinding((ConstraintLayout) rootView, logoutButton, profileImageView,
          theUserId, userIdTextView);
    }
