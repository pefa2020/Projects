...
- [x] (2 pts) **Live data is loaded from the NY Times API.**
    - ![Image/GIF showing additional email information](walkthrough_show.gif) <!-- Replace this link with your actual image/GIF link -->
- [x] (4 pts) **Books are displayed using a RecyclerView.**
    ...
    - ![Image/GIF showing required features](walkthrough_show.gif) <!-- Replace this link with your actual image/GIF link -->
...
- [x] (4 pts) **Improved layout and styling to match the NY Times website.**
    ...
    - ![Image/GIF showing stretch features](walkthrough_amazon.gif) <!-- Replace this link with your actual image/GIF link -->

## Notes

Describe any challenges encountered while building the app. <!-- Replace this with your specific challenges and experiences -->
Some challenges included adding the Amazon URL feature, specifically on retrieving the URL from the JSON.
