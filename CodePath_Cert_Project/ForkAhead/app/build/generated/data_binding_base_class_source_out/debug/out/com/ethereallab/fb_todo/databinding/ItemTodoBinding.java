...
public final class ItemTodoBinding implements ViewBinding {
  ...
  private ItemTodoBinding(@NonNull ConstraintLayout rootView, @NonNull TextView contentTextView) {
  ...
  public static ItemTodoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTodoBinding((ConstraintLayout) rootView, contentTextView);
    }
